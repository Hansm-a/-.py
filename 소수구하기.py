...
primecount=0                                            #input까지의 소수개수를 카운팅할 변수
i=0                                                     #for문과 출력에 쓰일 변수
j=0                                                     #for문에 쓰일 변수    

inputcount = input('몇번째 소수를 출력할까요? : ')        #입력받은값 inputcount에 저장

for i in range(1,999999999999) :                        #main for문 시작
    i=i+1                                               #i 증가
    for j in range(1,i) :                               #약수개수 counting for문 시작
        j=j+1                                           #j 증가
